			...
			<table>
				<tr>
					<td colspan="3">
						...
						value='<c:out value="${contaPoupanca.num_conta }"></c:out>'>
					</td>
					<td>
				...
				<tr>
					<td colspan="4">
						...
						value='<c:out value="${contaPoupanca.nome_cliente }"></c:out>'>
					</td>
				</tr>
				<td colspan="4">
						<input class="input_data" type="text"  id="dia_rendimento" name="dia_rendimento" placeholder="Dia do Rendimento"
						pattern="[0-9]*" title="Por favor, digite apenas números."  
						value='<c:out value="${contaPoupanca.rendimento }"></c:out>'>
					</td>
		...
		<form action="contaPoupanca" method="post">
			...
			<table>
				...
				<tr>
					...
					<td>
						<input type="submit" id="botao" name="botao" value="Calcular Rendimento">
					</td>
				</tr>
			</table>
		</form>
				...
				<tbody>
					<c:forEach var="c" items="${contas }">
						<tr>
							...
							<td class="lista_ultimoelemento"><c:out value="${c.rendimento } " /></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
